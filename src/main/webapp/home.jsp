        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="program">
              ...
              <div class="program-body">
                <h3 class="heading mb-2"><a href="#">Build Resilience</a></h3>
                <p><a href="#">Cross fit </a> with <a href="#">Kit Rich</a></p>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="program">
              ...
              <div class="program-body">
                ...
                <p><a href="#">Personal body training</a> with <a href="#">David Scott</a></p>
                <div class="span"><span class="mr-4"><span class="icon-schedule icon"></span> 20 min</span> <span> <span class="icon-signal icon"></span> Beginner</span></div>
              </div>
            </div>
          </div>
